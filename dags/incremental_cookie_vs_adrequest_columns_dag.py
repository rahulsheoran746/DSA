...
with DAG(
    dag_id='incremental_cookie_vs_adrequest_columns_dag',
    default_args=default_args,
    description='incremental_cookie_vs_adrequest_columns_dag.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_cookie_vs_adrequest_columns_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_cookie_vs_adrequest_columns.py'
                ]
            }
        }
    ]
