...
with DAG(
    dag_id='incremental_activity_update_dag',
    default_args=default_args,
    description='incremental_activity_update_dag.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_activity_update_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_activity_update.py'
                ]
            }
        }
    ]
