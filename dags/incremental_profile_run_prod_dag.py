...
with DAG(
    dag_id='incremental_profile_run_prod_dag',
    default_args=default_args,
    description='incremental_profile_run_prod_dag.',
    schedule_interval='50 10 * * 0',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_profile_run_prod_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_profile_run_prod.py'
                ]
            }
        }
    ]
