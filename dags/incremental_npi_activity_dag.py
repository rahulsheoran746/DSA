...
with DAG(
    dag_id='incremental_npi_activity_dag',
    default_args=default_args,
    description='incremental_npi_activity_dag.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_npi_activity_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_npi_activity.py'
                ]
            }
        }
    ]
