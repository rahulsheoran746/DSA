...
with DAG(
    dag_id='kythera_mx_submits_snowflake',
    default_args=default_args,
    description='Kythera data transfer to Snowflake.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'kythera_mx_submits_snowflake',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/kythera_mx_submits_snowflake.py'
                ]
            }
        }
    ]
