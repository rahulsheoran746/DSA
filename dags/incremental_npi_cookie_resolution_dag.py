...
with DAG(
    dag_id='incremental_npi_cookie_resolution',
    default_args=default_args,
    description='incremental_npi_cookie_resolution.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_npi_cookie_resolution',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/npi_cookie_resolution.py'
                ]
            }
        }
    ]
