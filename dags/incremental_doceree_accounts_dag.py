...
with DAG(
    dag_id='incremental_doceree_accounts_dag',
    default_args=default_args,
    description='incremental_doceree_accounts_dag.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_doceree_accounts_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_doceree_accounts.py'
                ]
            }
        }
    ]
