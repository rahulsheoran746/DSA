...
with DAG(
    dag_id='throttle_cookies_snowflake',
    default_args=default_args,
    description='Throttle cookies data transfer to Snowflake.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'throttle_cookies_snowflake',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/throttle_cookies_snowflake.py'
                ]
            }
        }
    ]
