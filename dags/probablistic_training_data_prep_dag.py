...
with DAG(
    dag_id='probablistic_training_data_dag',
    default_args=default_args,
    description='probablistic_training_data_dag.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'probablistic_training_data_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/probablistic_training_data_prep.py'
                ]
            }
        }
    ]
