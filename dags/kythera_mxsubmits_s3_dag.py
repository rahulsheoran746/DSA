...
with DAG(
    dag_id='kythera_mx_submits_s3',
    default_args=default_args,
    description='Kythera data transfer to S3.',
    schedule_interval='30 10 6 * *',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/kythera_mx_submits_s3.py'
                ]
            }
        }
    ]
