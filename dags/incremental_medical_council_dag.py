...
with DAG(
    dag_id='incremental_medical_council_dag',
    default_args=default_args,
    description='incremental_medical_council_dag',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_medical_council_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_medical_council.py'
                ]
            }
        }
    ]
