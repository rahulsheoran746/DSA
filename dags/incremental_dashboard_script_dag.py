...
with DAG(
    dag_id='incremental_dashboard_script_dag',
    default_args=default_args,
    description='incremental_dashboard_script_dag.',
    ...
    create_emr_cluster = EmrCreateJobFlowOperator(
        ...
        job_flow_overrides={
            'Name': 'incremental_dashboard_script_dag',
    ...
    emr_job_steps = [
        {
            ...
            'HadoopJarStep': {
                ...
                'Args': [
                    ...
                    's3://airflowcdp/code/incremental_dashboard_script.py'
                ]
            }
        }
    ]
